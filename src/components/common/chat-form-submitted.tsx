export const ChatFormSubmitted = ({ }) => {
    ...
    <div className="relative isolate bg-gray-900 h-[calc(100%-50px)] mb-20">
      <div className="relative px-6 pb-10 pt-10">
        <div className="mx-auto">
          ...
          <h2 className="text-xl font-semibold  text-white">Your message has been sent</h2>
          <p className="mt-2 leading-8 text-gray-300">We will get back to you shortly</p>
        </div>
      </div>
    </div>
  );
